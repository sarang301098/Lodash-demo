...
*/
const callMathMinBy = () => (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    console.log('\n\n ------------- Math MinBy ---------------------');
    const minByTestDataOneRes = _.minBy(minByTestDataOne, function getCode(o) { return o.code; });
...
exports.callMathMinBy = callMathMinBy;
